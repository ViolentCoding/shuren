        ...
        <div class="loginForminput">
          <div class="login-container">
            <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
              <h1 style="color:#9ab734;margin-top:-40px;margin-bottom:50px">登录</h1>
              <div class="title-container">
                <p :class="{'activeColor':active === 1}" style="border-right:1px solid #c3c3c3" @click="onTab(1)">密码登录</p>
                <p :class="{'activeColor':active === 2}" @click="onTab(2)">验证码登录</p>
              </div>
              ...
              <el-form-item v-show="word" prop="password">
                <el-input
                  :key="passwordType"
                  ref="password"
              ...
              <el-form-item v-show="captch" class="captchpass" prop="captch">
                <el-input
                  :key="passwordType"
                  ref="password"
              ...
              <div style="width:100%">
                <p style="float:right;color:#9ab734;font-size:14px">忘记密码?</p>
              </div>
              <div class="tips">
                <el-button :loading="loading" type="primary" style="width:26%;margin-bottom:30px" @click.native.prevent="handleLogin">登录</el-button>
