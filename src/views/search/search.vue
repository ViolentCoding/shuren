 ...
 * @LastEditors: 赵新朋
 * @LastEditTime: 2020-03-14 17:40:07
 * @Description
 -->
<template>
  <div class="contentBox">
    ...
    <div class="topcard">
      ...
      <div class="cardbox">
        <div class="elcard" v-for="(o, index) in recomList" :key="index"  @click="cardInfo(index)">
          <el-card :body-style="{ padding: '0px',position:'relative',width:'22vw'}">
            ...
            <div class="contentcard">
              ...
              <div style="padding: 0.4vw;">
                ...
                <div class="bottom clearfix">
                  <p>{{o.age}}岁·本科·{{o.jobtime}}年经验</p>
                  <p>期望薪资：{{o.salaryExpectation}}</p>
    ...
    <el-dialog  :visible.sync="outerVisible">
      ...
      <div class="diaconbox">
        ...
        <span slot="footer" class="dialog-footer" style="paddingLeft:30px;color:#9ab734;">
          ...
          <div class="heardUser">
            <img :src="user.img" alt="" style="border:1px solid #c3c3c3">
          ...
          <div class="content">
            <div class="contentJob">
               <h2>工作经历</h2>
              <div class="jobBox" v-for="(item,index) in user.uexperiences" :key="index">
                  <p>
                  <b>{{item.company}}</b> 丨
                  <b>{{item.position}}</b>
                  </p>
          ...
          <div slot="footer" class="dialog-footer" >
            <span style="padding-right:400px" @click="favorite()"><i class="el-icon-star-off" v-show="keep1"> 收藏简历 </i> <i class="el-icon-star-on" v-show="keep2"> 取消收藏 </i>  </span>
